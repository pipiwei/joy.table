...
JoyTable.prototype.GetOutputContent = function GetOutputContent(columnObjs, columnIdx, data, isTitle) {
    ...
    for (var i = 0; i < dataSet.length; i++) {
        ...
        finalOutputContent = finalOutputContent.replace(new RegExp("\\$\\{" + i + "\\}", "g"), displayContent).trim();
...
JoyTable.prototype.OnRowClicked = function (rowDomObjs) {
